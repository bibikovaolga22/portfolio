    ...
    return (
        <section className='projects' id='projects'>
            <div className='container'>
                ...
                <Right headline='Udacity  Project / Front End' name='Landing Page' description='Landing page with dynamic and updating navigation, allowing users to easily navigate between page sections. It demonstrates such features as: smooth scroll and sticky header and also button
                 that brings user to the top of the page.  ' usedTechnologies='HTML, CSS, Java Script' background={landingPage} externalLink="https://github.com/bibikovaolga22/landing-page-udacity/tree/master" />
                ...
                <Right headline='Udacity  Project / UX' name='MyTrail App ' description='A capstone project of UX Design course. An app where users would be able to find all the necessary info about their trail. ' usedTechnologies='Figma, Miro, Zeplin' background={mytrail1} externalLink="https://github.com/bibikovaolga22/my-trail-ux-project" />
            </div>
