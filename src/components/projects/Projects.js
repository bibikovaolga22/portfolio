    ...
    return (
        <section className='projects' id='projects'>
            <div className='container'>
                ...
                Also there is an option to remove books from the shelf. " usedTechnologies="React, Framer Motion, Books API" background={bookshelf} />
                ...
                smooth scroll and  steaky header and also button that brings user to the top of the page.  ' usedTechnologies='HTML, CSS, Java Script' background={landingPage} />
                ...
                and a number of days between current date and the chosen date." usedTechnologies="HTML,CSS, JavaScript, Webpack" background={travelApp} />
                ...
                their trail. ' usedTechnologies='Figma, Miro, Zeplin' background={mytrail1} />
            </div>
